...
public abstract class ApiResponseHelper : IResult
{
    ...
    public static IResult Created<T>(T data)
    {
    ...
    {
        return Results.CreatedAtRoute(routeName, routeValues, data);
    }
    ...
    {
        return Results.BadRequest(CreateProblemDetails("Bad Request", error, 400));
    }
    ...
    {
        return Results.NotFound(CreateProblemDetails("Not Found", $"{resource} not found", 404));
    }
    ...
    public static IResult ConflictDuplicate(string resource)
    {
        return Results.Conflict(
            CreateProblemDetails("Conflict", $"{resource} already exists", 409)
        );
    }
    ...
    {
        return Results.BadRequest(CreateProblemDetails(error, detail, 400));
    }
    ...
    {
        return Results.Problem(
            CreateProblemDetails(statusCode.ToString(), detail, (int)statusCode, errorData)
        );
    }
